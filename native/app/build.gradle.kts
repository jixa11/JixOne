...
val jixoneKeystoreFile = rootProject.file("../android/jixone.keystore")
...
android {
    ...
    signingConfigs {
        ...
        // Same key as the rest of JixOne — see docs/SIGNING.md. Kept out of
        // the repo, so a build without it falls back to the debug key below.
        if (jixoneKeystoreFile.exists()) {
            create("release") {
                storeFile = jixoneKeystoreFile
                storePassword = System.getenv("JIXONE_STORE_PASSWORD") ?: System.getenv("STORE_PASSWORD")
                keyAlias = System.getenv("JIXONE_KEY_ALIAS") ?: System.getenv("KEY_ALIAS") ?: "jixone"
                keyPassword = System.getenv("JIXONE_KEY_PASSWORD") ?: System.getenv("KEY_PASSWORD")
            }
        }
        getByName("debug") {
            keyAlias = "androiddebugkey"
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "JixOne Debug")
            }
            signingConfig =
