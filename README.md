...
**Current build: v1.2.0-beta3** · [download the APK](public/JixOne-v1.2.0-beta3.apk)
...
```bash
./build-apk.sh
# result: download/JixOne-v1.2.0-beta3.apk
```
...
```bash
./build-apk.sh
# خروجی: download/JixOne-v1.2.0-beta3.apk
```
