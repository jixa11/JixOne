...
const dict = {
  fa: {
    ...
    pasteCookieTitle: 'ورود با کوکی (اگر صفحه‌ی ورود کار نکرد)',
    pasteCookieDesc: 'اگر گوگل داخل برنامه پیغام «this browser or app may not be secure» می‌دهد، در کروم دسکتاپ وارد music.youtube.com شو، DevTools را باز کن (F12) ← تب Network ← یکی از درخواست‌ها را بزن ← از Request Headers مقدار Cookie را کامل کپی کن و اینجا بچسبان.',
    pasteCookiePlaceholder: 'VISITOR_INFO1_LIVE=…; SAPISID=…; __Secure-3PAPISID=…',
    pasteCookieSave: 'ذخیره‌ی کوکی',
    pasteCookieOk: 'وارد شدی',
    pasteCookieEmpty: 'چیزی نچسباندی',
    pasteCookieNoSapisid: 'این کوکی حساب واردشده نیست — SAPISID داخلش نبود. مطمئن شو در همان مرورگر لاگین هستی و کل مقدار Cookie را کپی کرده‌ای.',
  ...
  en: {
    ...
    pasteCookieTitle: 'Sign in with a cookie (if the login screen fails)',
    pasteCookieDesc: 'If Google answers "this browser or app may not be secure" inside the app, sign in to music.youtube.com in desktop Chrome, open DevTools (F12) → Network → click any request → copy the whole Cookie value from Request Headers, and paste it here.',
    pasteCookiePlaceholder: 'VISITOR_INFO1_LIVE=…; SAPISID=…; __Secure-3PAPISID=…',
    pasteCookieSave: 'Save cookie',
    pasteCookieOk: 'Signed in',
    pasteCookieEmpty: 'Nothing pasted',
    pasteCookieNoSapisid: 'That is not a signed-in cookie — no SAPISID in it. Make sure you are logged in on that browser and copied the whole Cookie value.',
