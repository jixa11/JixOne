...
**Current build: v1.2.0-beta4** · [download the APK](public/JixOne-v1.2.0-beta4.apk)
...
```bash
./build-apk.sh
# result: download/JixOne-v1.2.0-beta4.apk
```
...
```bash
./build-apk.sh
# خروجی: download/JixOne-v1.2.0-beta4.apk
```
